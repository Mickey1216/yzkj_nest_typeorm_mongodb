...
export class UserController {
  ...
  // 注册接口
  @Post('register')
  register(@Body() registerParams: User, @Session() session) {
    ...
    // // 验证用户名或邮箱或手机号是否已经注册
    // this.userService.checkExisted(registerParams.userName, registerParams.email, registerParams.phone)
    
    // let res = this.userService.register(registerParams)
    // return {
    //   code: res ? 200 : 400,
    //   msg: "注册" + (res ? "成功" : "失败")
    // }
